...
OpenGLWindow::OpenGLWindow(int windowWidth, int windowHeight, std::string windowTitle)
...
void OpenGLWindow::setWindowIcon(std::string iconPath)
{
	GLFWimage images[1];
...
void OpenGLWindow::setWindowTitle(std::string newTitle)
{
